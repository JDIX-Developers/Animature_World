...
public class Propiedades extends Properties
{
	...
	/**
	 * Constructor que recibe el nombre del idioma (ESPANOL o INGLES, de momento)
	 * @param idioma El idioma que recibe.
	 */
	 ...
	 * @param idioma El idioma del que se van a leer las propiedades.
	 */
