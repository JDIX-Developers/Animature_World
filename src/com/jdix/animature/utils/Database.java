...
public class Database extends SQLiteOpenHelper {
	...
	public void onCreate(final SQLiteDatabase db)
	{
		...
		db
		.execSQL("CREATE TABLE Attacks (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, type INTEGER, max_pp INTEGER, active INTEGER, ifPass INTEGER, power INTEGER, probability INTEGER)");
	}
