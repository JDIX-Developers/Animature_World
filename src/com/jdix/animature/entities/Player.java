...
public class Player {
	...
	public void save(final Context context)
	{
		...
		values
		.put("an1", (activeAnimatures[0] != null
		&& activeAnimatures[0].getId() != 0 ? activeAnimatures[0].getId()
		: null));
		values
		.put("an2", (activeAnimatures[1] != null
		&& activeAnimatures[1].getId() != 0 ? activeAnimatures[1].getId()
		: null));
		values
		.put("an3", (activeAnimatures[2] != null
		&& activeAnimatures[2].getId() != 0 ? activeAnimatures[2].getId()
		: null));
		values
		.put("an4", (activeAnimatures[3] != null
		&& activeAnimatures[3].getId() != 0 ? activeAnimatures[3].getId()
		: null));
		values
		.put("an5", (activeAnimatures[4] != null
		&& activeAnimatures[4].getId() != 0 ? activeAnimatures[4].getId()
		: null));
		values
		.put("an6", (activeAnimatures[5] != null
		&& activeAnimatures[5].getId() != 0 ? activeAnimatures[5].getId()
		: null));
